...
#SBATCH -o sm_full_original.out
#SBATCH -e sm_full_original.err
#SBATCH --no-requeue
#SBATCH --export=NONE
#SBATCH --get-user-env
    ...
    for ranks in 1 2 4 8 16; do
        for N in 63 127 255 511 1023 2047 4095 8191 16383 32767; do
            if [ $N -ge 16383 ] && [ $ranks -lt 4 ]; then
                echo "--- skipping $ranks ranks, n=$N, original, $sm (memory/time) ---"
                continue
            fi
